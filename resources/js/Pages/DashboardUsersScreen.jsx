...
function DashboardUsersScreen({ employees }) {
    ...
    const fetchData = (page) => {
        router.get(`/dashboard/employee`, { page, search }, { preserveState: true });
    };
    ...
    const handleSubmit = async (event) => {
        ...
        if (employeeName == '') {
            ...
            try {
                router.post('/add-employee', { name: employeeName, title, about, image },
                    {
                        onSuccess: () => {
                ...
                >
                    ...
                    >
                       ...
                       <path strokeLinecap="round" strokeLinejoin="round" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z" />
                            ...
                            <Input label='Image' accept=".jpg,.jpeg,.png" size='md' type='file'
                                onChange={handleImageChange}
                            />
                            <Input label='Name' color='deep-orange'
                                value={employeeName} onChange={(event) => setEmployeeName(event.target.value)} size='sm'
                            />

                            <Input label='Title' color='deep-orange'
                                value={title} onChange={(event) => setTitle(event.target.value)} size='sm'
                            />
                            <Input label='About' color='deep-orange'
                                value={about} onChange={(event) => setAbout(event.target.value)} size='sm'
                            />
...
DashboardUsersScreen.layout = page => <Layout children={page} />
