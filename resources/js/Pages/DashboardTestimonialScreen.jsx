...
function DashboardTestimonialScreen({testimonials}) {
console.log(testimonials)
        ...
        const handleSubmit = async (event) => {
            ...
            post('/dashboard/testimonials/post', {
...
DashboardTestimonialScreen.layout = page => <Layout children={page} />
export default DashboardTestimonialScreen