...
function CareersScreen() {
    return (
        <div>
            ...
            <div className="p-5 grid gap-8 lg:grid-cols-4 md:grid-cols-2 md:max-w-full sm:max-w-sm sm:mx-auto lg:max-w-full">
                <Jobcard/>
                <Jobcard/>
                <Jobcard/>
                <Jobcard/>
...
CareersScreen.layout = page => <Layout children={page} />
