...
function Teamcard({ employee }) {
  ...
  return (
    <Fragment>
      ...
      <div class="w-full max-w-xs text-center mx-auto my-4">
        <img class="object-cover object-top w-full h-48 mx-auto rounded-lg" src={employee.image} alt="hannah" />

        <div class="mt-2">
          <h3 class="text-lg font-medium text-gray-700 ">{employee.name}</h3>
          <span class="mt-1 text-xs text-gray-600 ">{employee.title}</span>
        </div>
      </div>
