...
function UserMenu({props}) {
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <img src={'/images/resources/kiru-logo.png'} className="w-8 h-8 rounded-full"

          width="32" height="32" alt=""
        />
        <div className="flex items-center truncate">
          <span className="ml-2 text-sm font-medium truncate group-hover:text-gray-800">Kiru</span>
        ...
        <section className="origin-top-right z-10 absolute top-full right-0 min-w-44 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1">
          ...
          >
            <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
              <div className="font-medium text-gray-800">Kiru</div>
              <div className="text-xs italic text-gray-500">kiru</div>
            </div>
            {/* <ul>
              <li>
                <Link
