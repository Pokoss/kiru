        ...
        <div>
          <ul className="mt-2">
            ...
            <li className="rounded-sm mb-0.5 ">
              <Link href={`/dashboard/`} className="w-full block text-gray-200 hover:bg-brown-500 p-2">
            ...
            {/* Customers */}
            <li className="rounded-sm mb-0.5">
              <Link href={`/dashboard/events`} className="block text-gray-200 hover:bg-brown-500 p-2">
                <div className="flex items-center flex-grow">
            ...
            <li className="rounded-sm mb-0.5">
              <Link href={`/dashboard//hr`} className="block text-gray-200 hover:bg-brown-500 p-2">
                <div className="flex items-center flex-grow">
            ...
            <li className="rounded-sm mb-0.5">
              <Link href={`/dashboard//wallet`} className="block text-gray-200 hover:bg-brown-500 p-2">
                <div className="flex items-center flex-grow">
                <svg className="w-6 h-6 mr-3" fill="none" viewBox="0 0 20 20" stroke="currentColor" >
