            ...
            <section className="p-6">
                ...
                <img src="/images/gallery/kiru-06.JPG" alt="" className="object-cover w-full rounded-md xl:col-span-3 dark:bg-gray-500" />
                    <div className="w-full px-6 rounded-md sm:px-12 md:px-16 xl:col-span-2 ">
                        ...
                        <p className="my-5">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odit, nulla? Velit nostrum iusto qui laborum possimus incidunt inventore veritatis magni corporis quam, ab sint voluptas quis voluptatum amet, fuga tempora?
                        </p>
